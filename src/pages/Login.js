    ...
    return (
        ...
        <div className="max-w-md w-full relative">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
                ...
                <Link to="/forgot-password" className="text-sm text-gray-400 hover:text-white transition-colors duration-300">
                    ลืมรหัสผ่าน?
                </Link>
                </div>
                ...
                <Link to="/register" className="text-white hover:text-purple-300 transition-colors duration-300">
                    สมัครสมาชิก
                </Link>
                </div>
            </form>
